...
import { fetchDoctors, fetchPharmacist, fetchUserOrDoctorOrPharmacist, updateDoctor, updatePharmacist, updateUser } from '../controllers/userController';
...
router.get('/pharmacist/:id', fetchPharmacist)
router.route('/doctor')
